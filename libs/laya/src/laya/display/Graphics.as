package laya.display {
	...
	public class Graphics {
		...
		public function drawTextures(texture:Texture, pos:Array):DrawTexturesCmd {
			if (!texture) return null;
			return _saveToCmd(Render._context.drawTextures, DrawTexturesCmd.create.call(this, texture, pos));
		}
		...
		public function clipRect(x:Number, y:Number, width:Number, height:Number):ClipRectCmd {
			return _saveToCmd(Render._context.clipRect, ClipRectCmd.create.call(this, x, y, width, height));
		}
		...
		public function fillText(text:String, x:Number, y:Number, font:String, color:String, textAlign:String):FillTextCmd {
			return _saveToCmd(Render._context.fillText, FillTextCmd.create.call(this, text, x, y, font || Text.defaultFontStr(), color, textAlign));
		}
		...
		public function fillBorderText(text:String, x:Number, y:Number, font:String, fillColor:String, borderColor:String, lineWidth:Number, textAlign:String):FillBorderTextCmd {
			return _saveToCmd(Render._context.fillBorderText, FillBorderTextCmd.create.call(this, text, x, y, font || Text.defaultFontStr(), fillColor, borderColor, lineWidth, textAlign));
		}
		
		/*** @private */
		public function fillWords(words:Array, x:Number, y:Number, font:String, color:String):FillWordsCmd {
			return _saveToCmd(Render._context.fillWords, FillWordsCmd.create.call(this, words, x, y, font || Text.defaultFontStr(), color));
		}
		...
		public function fillBorderWords(words:Array, x:Number, y:Number, font:String, fillColor:String, borderColor:String, lineWidth:int):FillBorderWordsCmd {
			return _saveToCmd(Render._context.fillBorderWords, FillBorderWordsCmd.create.call(this, words, x, y, font || Text.defaultFontStr(), fillColor, borderColor, lineWidth));
		}
		...
		public function strokeText(text:String, x:Number, y:Number, font:String, color:String, lineWidth:Number, textAlign:String):StrokeTextCmd {
			return _saveToCmd(Render._context.fillBorderText, StrokeTextCmd.create.call(this, text, x, y, font || Text.defaultFontStr(), null, color, lineWidth, textAlign));
		}
		...
		public function alpha(alpha:Number):AlphaCmd {
			return _saveToCmd(Render._context.alpha, AlphaCmd.create.call(this, alpha));
		}
		...
		public function translate(tx:Number, ty:Number):TranslateCmd {
			return _saveToCmd(Render._context.translate, TranslateCmd.create.call(this, tx, ty));
		}
		...
		public function restore():RestoreCmd {
			return _saveToCmd(Render._context.restore, RestoreCmd.create.call(this));
		}
		...
		public function drawLine(fromX:Number, fromY:Number, toX:Number, toY:Number, lineColor:String, lineWidth:Number = 1):DrawLineCmd {
			...
			return _saveToCmd(Render._context._drawLine, DrawLineCmd.create.call(this, fromX + offset, fromY + offset, toX + offset, toY + offset, lineColor, lineWidth, 0));
		}
		...
		public function drawLines(x:Number, y:Number, points:Array, lineColor:*, lineWidth:Number = 1):DrawLinesCmd {
			...
			var offset:Number = (lineWidth < 1 || lineWidth % 2 === 0) ? 0 : 0.5;
			//TODO 线段需要缓存
			return _saveToCmd(Render._context._drawLines, DrawLinesCmd.create.call(this, x + offset, y + offset, points, lineColor, lineWidth, 0));
		}
		...
		public function drawCurves(x:Number, y:Number, points:Array, lineColor:*, lineWidth:Number = 1):DrawCurvesCmd {
			return _saveToCmd(Render._context.drawCurves, DrawCurvesCmd.create.call(this, x, y, points, lineColor, lineWidth));
		}
		...
		public function drawCircle(x:Number, y:Number, radius:Number, fillColor:*, lineColor:* = null, lineWidth:Number = 1):DrawCircleCmd {
			var offset:Number = (lineWidth >= 1 && lineColor) ? lineWidth / 2 : 0;
			return _saveToCmd(Render._context._drawCircle, DrawCircleCmd.create.call(this, x, y, radius - offset, fillColor, lineColor, lineWidth, 0));
		}
		...
		public function drawPie(x:Number, y:Number, radius:Number, startAngle:Number, endAngle:Number, fillColor:*, lineColor:* = null, lineWidth:Number = 1):DrawPieCmd {
			...
			return _saveToCmd(Render._context._drawPie, DrawPieCmd.create.call(this, x + offset, y + offset, radius - lineOffset, Utils.toRadian(startAngle), Utils.toRadian(endAngle), fillColor, lineColor, lineWidth, 0));
		}
		...
		public function drawPoly(x:Number, y:Number, points:Array, fillColor:*, lineColor:* = null, lineWidth:Number = 1):DrawPolyCmd {
			...
			//TODO 非凸多边形需要缓存
			return _saveToCmd(Render._context._drawPoly, DrawPolyCmd.create.call(this, x + offset, y + offset, points, fillColor, lineColor, lineWidth, tIsConvexPolygon, 0));
		}

package laya.webgl.submit {
	...
	public class Submit implements ISubmit {
		 ...
		 */
		//TODO:coverage
		protected function _cloneInit(o:Submit,context:Context, mesh:Mesh2D, pos:int):void
		{
			;
			o._ref=1;
			//o._ib = ib;
		...
		//TODO:coverage
		public function clone(context:Context,mesh:Mesh2D,pos:int):ISubmit
		{
			;
			/*
		 ...
		 * @return
		 */
		public static function createShape(ctx:Context, mesh:Mesh2D, numEle:int, sv:Value2D):Submit {
			var o:Submit = _poolSize ? POOL[--_poolSize]:(new Submit());
			o._mesh = mesh;
			o._numEle = numEle;

package laya.resource {
	...
	public class Texture2D extends BaseTexture {
		/**纯灰色纹理。*/
		public static var grayTexture:Texture2D=null;
		/**纯白色纹理。*/
		public static var whiteTexture:Texture2D = null;
		/**纯黑色纹理。*/
		public static var blackTexture:Texture2D=null;
		...
		public static function __init__():void {
			...
			pixels[1] = 255;
			pixels[2] = 255;
			whiteTexture = new Texture2D(1, 1, FORMAT_R8G8B8, false, false);
			whiteTexture.setPixels(pixels);
			whiteTexture.lock = true;//锁住资源防止被资源管理释放
			pixels[0] = 0;
			pixels[1] = 0;
			pixels[2] = 0;
			blackTexture = new Texture2D(1, 1, FORMAT_R8G8B8, false, false);

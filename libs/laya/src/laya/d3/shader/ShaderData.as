package laya.d3.shader {
	...
	public class ShaderData implements IClone {
		/**@private */
		private var _ownerResource:Resource = null;
		/**@private */
		 ...
		 * @private
		 */
		public function ShaderData(ownerResource:Resource = null) {
		...
		public function getDataForNative():Array {//[NATIVE]
			return _nativeArray;
		}
		 ...
		 *@private [NATIVE]
		 */
		public function getIntForNative(index:int):int {//[NATIVE]
		 ...
		 *@private [NATIVE]
		 */
		public function setIntForNative(index:int, value:int):void {//[NATIVE]
		 ...
		 *@private [NATIVE]
		 */
		public function getBoolForNative(index:int):Boolean {//[NATIVE]
		 ...
		 *@private [NATIVE]
		 */
		public function setBoolForNative(index:int, value:Boolean):void {//[NATIVE]
			needRenewArrayBufferForNative(index);
			_int32Data[index] = value;
			_nativeArray[index] = value;
		}
		 ...
		 *@private [NATIVE]
		 */
		public function getNumberForNative(index:int):Number {//[NATIVE]
		 ...
		 *@private [NATIVE]
		 */
		public function setNumberForNative(index:int, value:Number):void {//[NATIVE]
			needRenewArrayBufferForNative(index);
		 ...
		 *@private [NATIVE]
		 */
		public function getMatrix4x4ForNative(index:int):Matrix4x4 {//[NATIVE]
		 ...
		 *@private [NATIVE]
		 */
		public function setMatrix4x4ForNative(index:int, value:Matrix4x4):void {//[NATIVE]
			needRenewArrayBufferForNative(index);
		 ...
		 *@private [NATIVE]
		 */
		public function getVectorForNative(index:int):* {//[NATIVE]
			return _nativeArray[index];
		}
		 ...
		 *@private [NATIVE]
		 */
		public function setVectorForNative(index:int, value:*):void {//[NATIVE]
			needRenewArrayBufferForNative(index);
			_nativeArray[index] = value;//保存引用
			if (!value.elements) {
		 ...
		 *@private [NATIVE]
		 */
		public function getVector2ForNative(index:int):* {//[NATIVE]
			return _nativeArray[index];
		}
		 ...
		 *@private [NATIVE]
		 */
		public function setVector2ForNative(index:int, value:*):void {//[NATIVE]
			needRenewArrayBufferForNative(index);
			_nativeArray[index] = value;//保存引用
			if (!value.elements) {
				value.forNativeElement();
		 ...
		 *@private [NATIVE]
		 */
		public function getVector3ForNative(index:int):* {//[NATIVE]
			return _nativeArray[index];
		}
		 ...
		 *@private [NATIVE]
		 */
		public function setVector3ForNative(index:int, value:*):void {//[NATIVE]
			needRenewArrayBufferForNative(index);
			_nativeArray[index] = value;//保存引用
			if (!value.elements) {
				value.forNativeElement();
		 ...
		 *@private [NATIVE]
		 */
		public function getQuaternionForNative(index:int):Quaternion {//[NATIVE]
			return _nativeArray[index];
		}
		 ...
		 *@private [NATIVE]
		 */
		public function setQuaternionForNative(index:int, value:*):void {//[NATIVE]
			needRenewArrayBufferForNative(index);
			_nativeArray[index] = value;//保存引用
			if (!value.elements) {
				value.forNativeElement();
		 ...
		 *@private [NATIVE]
		 */
		public function getBufferForNative(shaderIndex:int):Float32Array {//[NATIVE]
		 ...
		 *@private [NATIVE]
		 */
		public function setBufferForNative(index:int, value:Float32Array):void {//[NATIVE]
			needRenewArrayBufferForNative(index);
			_nativeArray[index] = value;//保存引用
		 ...
		 *@private [NATIVE]
		 */
		public function getAttributeForNative(index:int):Array {//[NATIVE]
			return _nativeArray[index];
		}
		 ...
		 *@private [NATIVE]
		 */
		public function setAttributeForNative(index:int, value:Int32Array):void {//[NATIVE]
			_nativeArray[index] = value;//保存引用
			if (!value["_ptrID"]) {
		 ...
		 *@private [NATIVE]
		 */
		public function getTextureForNative(index:int):BaseTexture {//[NATIVE]
			return _nativeArray[index];
		}
		 ...
		 *@private [NATIVE]
		 */
		public function setTextureForNative(index:int, value:BaseTexture):void {//[NATIVE]
			if (!value) return;
			needRenewArrayBufferForNative(index);
			var lastValue:BaseTexture = _nativeArray[index];
			_nativeArray[index] = value;//保存引用
			_int32Data[index] = (value as Object)._glTexture.id;
			if (_ownerResource && _ownerResource.referenceCount > 0) {
				(lastValue) && (lastValue._removeReference());
				(value) && (value._addReference());
			}
		...
		public function setReferenceForNative(value:*):int {//[NATIVE]
			//清空保存的数据
		...
		public static function setRuntimeValueMode(bReference:Boolean):void {//[NATIVE]

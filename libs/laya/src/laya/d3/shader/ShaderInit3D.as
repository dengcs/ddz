package laya.d3.shader {
	...
	public class ShaderInit3D {
		...
		public static function __init__():void {
			...
			uniformMap = {
				'u_ScreenTexture': Shader3D.PERIOD_MATERIAL
			};
				
			vs = __INCLUDESTR__("files/ScreenQuad.vs");
			ps = __INCLUDESTR__("files/ScreenQuad.ps");
			...
			shader.addSubShader(subShader);
			shaderPass = subShader.addShaderPass(__INCLUDESTR__("files/postProcess/Bloom.vs"), __INCLUDESTR__("files/postProcess/BloomPrefilter13.ps"));
			...
			subShader = new SubShader(null, null, null, null);
			shader.addSubShader(subShader);
			shaderPass = subShader.addShaderPass(__INCLUDESTR__("files/postProcess/Bloom.vs"), __INCLUDESTR__("files/postProcess/BloomPrefilter4.ps"));
			renderState = shaderPass.renderState;
			renderState.depthTest = RenderState.DEPTHTEST_ALWAYS;
			renderState.depthWrite = false;
			renderState.cull = RenderState.CULL_NONE;
			...
			subShader = new SubShader(null, null, null, null);
			shader.addSubShader(subShader);
			shaderPass = subShader.addShaderPass(__INCLUDESTR__("files/postProcess/Bloom.vs"), __INCLUDESTR__("files/postProcess/BloomDownsample13.ps"));
			renderState = shaderPass.renderState;
			renderState.depthTest = RenderState.DEPTHTEST_ALWAYS;
			renderState.depthWrite = false;
			renderState.cull = RenderState.CULL_NONE;
			...
			subShader = new SubShader(null, null, null, null);
			shader.addSubShader(subShader);
			shaderPass = subShader.addShaderPass(__INCLUDESTR__("files/postProcess/Bloom.vs"), __INCLUDESTR__("files/postProcess/BloomUpsampleTent.ps"));
			renderState = shaderPass.renderState;
			renderState.depthTest = RenderState.DEPTHTEST_ALWAYS;
			renderState.depthWrite = false;
			renderState.cull = RenderState.CULL_NONE;
			...
			subShader = new SubShader(null, null, null, null);
			shader.addSubShader(subShader);
			shaderPass = subShader.addShaderPass(__INCLUDESTR__("files/postProcess/Bloom.vs"), __INCLUDESTR__("files/postProcess/BloomUpsampleBox.ps"));
			renderState = shaderPass.renderState;
			renderState.depthTest = RenderState.DEPTHTEST_ALWAYS;
			renderState.depthWrite = false;
			renderState.cull = RenderState.CULL_NONE;
			...
			shader.addSubShader(subShader);
			shaderPass = subShader.addShaderPass(__INCLUDESTR__("files/postProcess/Composite.vs"), __INCLUDESTR__("files/postProcess/Composite.ps"));
			renderState = shaderPass.renderState;
			renderState.depthTest = RenderState.DEPTHTEST_ALWAYS;
			renderState.depthWrite = false;
			renderState.cull = RenderState.CULL_NONE;

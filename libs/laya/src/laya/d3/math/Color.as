package laya.d3.math {
	...
	public class Color implements IClone {
		...
		public function toLinear(out:Color):void {
			out.r = Utils3D.gammaToLinearSpace(r);
			out.g = Utils3D.gammaToLinearSpace(g);
			out.b = Utils3D.gammaToLinearSpace(b);
		}
		...
		public function toGamma(out:Color):void {
			out.r = Utils3D.linearToGammaSpace(r);
			out.g = Utils3D.linearToGammaSpace(g);
			out.b = Utils3D.linearToGammaSpace(b);
		}

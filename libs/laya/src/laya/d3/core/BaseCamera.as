package laya.d3.core {
	...
	public class BaseCamera extends Sprite3D {
		...
		public static const VIEWPROJECTMATRIX:int = Shader3D.propertyNameToID("u_ViewProjection");
		 ...
		 * @private
		 */
		public function _prepareCameraViewProject(vieMat:Matrix4x4, proMat:Matrix4x4, viewProject:Matrix4x4, vieProNoTraSca:Matrix4x4):void {
			var shaderData:ShaderData = _shaderValues;
